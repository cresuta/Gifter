...
namespace Gifter.Utils
{
    ...
    public static class DbUtils
    {
        ...
        public static string GetPostRecords()
        {
            return "p.Id AS PostId, p.Title, p.Caption, p.DateCreated AS PostDateCreated, p.ImageUrl AS PostImageUrl, p.UserProfileId";
        }

        public static string GetUserProfileRecords()
        {
            return "up.Name, up.Bio, up.Email, up.DateCreated AS UserProfileDateCreated, up.ImageUrl AS UserProfileImageUrl";
        }
    }
}